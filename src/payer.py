...
class UninitializedAccount(NamedTuple):
    ...
    instruction: Union[TransactionInstruction, Transaction]
...
class Payer(Account):
    ...
    def __init__(
        self, conn: Client, dex_program_id: PublicKey, secret_key: Optional[Union[bytes, str, List[int], int]] = None
    ) -> None:
    ...
    def create_program_account(
        ...
        return UninitializedAccount(new_account, sys_lib.create_account(create_account_params))
